...
@JsonIgnoreProperties({"createdAt", "updatedAt","usdaId","longDesc","commonName","mfgName","usdaSurvey","refuseDesc","refusePercentage","nFactor","refusePercentage","scientificName","pFactor","choFactor","addedBy","updatedBy","citation","fFactor"})
